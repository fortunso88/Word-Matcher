...
public class Gui extends JFrame {
    ...
    private String DocumentoSceltoM;
    ...
    private Gui() {
        ...
        URL urlB =getClass().getResource("/progettoing/img/back.jpg");
    ...
    private void initComponents() {
        ...
        howToM = new javax.swing.JMenuItem();
        ...
        caseSensitive.setText("No Case Sensitive");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(subString, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                                .addGap(26, 26, 26))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        howTo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/progettoing/img/How-to.png"))); // NOI18N
        howTo.setActionCommand("howTT");
        howTo.setBorder(null);
        howTo.setFocusable(false);
        howTo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        howTo.setOpaque(false);
        howTo.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        howToM.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_MASK));
        howToM.setBackground(new java.awt.Color(255, 255, 255));
        howToM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/progettoing/img/How-toM.png"))); // NOI18N
        howToM.setText("How To..");
        howToM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                howToMActionPerformed(evt);
            }
        });
        help.add(howToM);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(search)
                                .addGap(72, 72, 72)
                                .addComponent(newSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(newSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(search, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)))
                        .addGap(18, 18, 18)
    ...
    private void apriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_apriActionPerformed
        ...
        String line="";
            ...
            if(!line.equals("")){
                ...
                DocumentoSceltoM=DocumentoScelto;
                EnableCheck();
            }
    ...
    private void caseSensitiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caseSensitiveActionPerformed
        ...
        if(caseSensitive.isSelected()){
            DocumentoScelto=DocumentoScelto.toLowerCase();
        }
        else{
            DocumentoScelto=DocumentoSceltoM;
        }
    ...
    private void howToActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_howToActionPerformed
        ...
        if(inputText.getText().equals("")){
            inputText.setContentType("text/html");
            inputText.setText("<div align=center><font size=\"4\" face=\"Comic Sans MS\"><span style=\"color: #ff0000;\"><br>Word Matcher: Guida all'uso<br><br></font></span></div><br><font size=\"4\" face=\"Comic Sans MS\"><span>" 
                    + "<div align=justify><font size=\"4\" face=\"Comic Sans MS\">Selezionare prima di tutto il file su cui lavorare,"
                    + "tramite il bottone Cartella, o dal menu a tendina File.<br>"
                    + "Scelto un file corretto, potrete inserire la parola da ricercare "
                    + "nella textArea che si attiva, e selezionare la caratteristica desiderata nella checkBox.<br><br>"
                    + "La ricerca avviene tramite la pressione del tasto Search.<br>"
                    + "Potrete salvare la vostra ricerca tramite il bottone con icona Floppy o dal menu a tendina File.<br><br>"
                    + "Se volete iniziare una nuova ricerca, premere il pulsante Lente di Ingrandimento.<br><br>"
                    + "Buona Ricerca");
            
        }
        else{
            JOptionPane optionPane = new JOptionPane(""
                    + "Hai gia' effettuato delle operazioni."
                    + "\nVuoi davvero visualizzare il messaggio d'aiuto?");
                     
            int r = optionPane.showConfirmDialog(null, optionPane.getMessage(), "Confirm", JOptionPane.YES_NO_OPTION);
    ...
    private void howToMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_howToMActionPerformed
        if(inputText.getText().equals("")){
            inputText.setContentType("text/html");
            inputText.setText("<div align=center><font size=\"4\" face=\"Comic Sans MS\"><span style=\"color: #ff0000;\"><br>Word Matcher: Guida all'uso<br><br></font></span></div><br><font size=\"4\" face=\"Comic Sans MS\"><span>" 
                    + "<div align=justify><font size=\"4\" face=\"Comic Sans MS\">Selezionare prima di tutto il file su cui lavorare,"
    ...
    }//GEN-LAST:event_howToMActionPerformed
    ...
    private javax.swing.JMenuItem howToM;
